...
export const sitePages = [
  ...
  { path: "/pricing", title: "Pricing", description: "FreeReader pricing: a free tier with 1 hour of audio generation each month, and Pro at $6/month for up to 20 hours across the audiobook reader and YouTube Narration Studio.", priority: 0.7, changeFrequency: "monthly" as const },
