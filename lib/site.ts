...
export const sitePages = [
  ...
  { path: "/pricing", title: "Pricing", description: "FreeReader pricing: a free tier with 1 hour of audio generation each month, Pro at $6/month for up to 10 hours, and a coming-soon Premium plan with voice cloning and 20 hours.", priority: 0.7, changeFrequency: "monthly" as const },
