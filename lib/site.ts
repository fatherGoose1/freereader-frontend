...
export const sitePages = [
  { path: "/", title: "FreeReader — Your books, out loud", description: "Turn any book into an audiobook. Listen to your EPUBs, PDFs, and text files with natural voices, free and private.", priority: 1, changeFrequency: "weekly" as const },
